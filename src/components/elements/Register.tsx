...
class Register extends Component<RegisterComponentProps, State> {
  ...
  handleUpload = async () => {
    ...
    if (
      ...
      this.props.onChildProps({
        responseMessage: "Register form must be filled correctly",
      });
      return;
    }
    ...
    this.props.onChildProps({
      responseMessage: "Registration successful, please log in",
    });
    this.setState({
      firstNameInput: "",
      lastNameInput: "",
      ...
      <div className="login-form-container">
        <div className="login-form centered" onSubmit={this.handleUpload}>
          ...
          <input
            ...
            type="text"
            onChange={(e) =>
              this.setState({ firstNameInput: e.currentTarget.value })
            }
          />
          <input
            ...
            type="text"
            onChange={(e) =>
              this.setState({ lastNameInput: e.currentTarget.value })
            }
          />
          <br />
          <input
            ...
            type="password"
            onChange={(e) =>
              this.setState({ passwordInput: e.currentTarget.value })
            }
          />
          <br />
          <input
            ...
            type="password"
            onChange={(e) =>
              this.setState({ passwordAgainInput: e.currentTarget.value })
            }
          />
          <br />
          <div className="submit-button-container centered">
            <button className="submit-button" onClick={this.handleUpload}>
              Continue
            </button>
          </div>
        </div>
