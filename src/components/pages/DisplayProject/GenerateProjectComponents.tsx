    ...
    return (
      <>
        <div className="create-project-layout">
          <div>
            <p id="about-artwork" style={{maxHeight: `${elementHeight.current}px`}}>A few words <br /> about this artwork</p>
            <p id="about-artwork-content">{projectData.description}</p>
          </div>
          <div>
            <img ref={elementRef} src={arrowRight} alt="" id="about-arrow-right"/>
          </div>
          <div>
            {
              imageData ? <img src={imageData} style={{width: '100%'}} alt="" placeholder="image" />
