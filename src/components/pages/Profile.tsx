...
class Profile extends Component<Props, State> {
  ...
  loadProjects = () => {
    ...
    for (let i = 0; i < this.state.projectsCount; i++) {
      projectsList.push(
        <div
          className={`project ${i === 0 ? "rounded-top-left" : ""}
                                                       ${
                                                         i === 2
                                                           ? "rounded-top-right"
                                                           : ""
          ...
          onClick={() => {
            this.props.navigate(
              `/display-project/${this.state.projectsData[i].projectId}`
            );
          }}
  ...
  handleInputDoubleclick = async () => {
    ...
    if (!this.state.showInput) {
      ...
      await updateProfileDetails(updateData).then(() => {
        this.loadUserDetailsFromDatabase();
      });
    }
  };
      ...
      <div>
        <div className="container centered profile-text">
          ...
          <div className="profile-container">
            ...
            <div className="about-container">
              ...
              {this.state.showInput ? (
                ...
                >
                  {this.state.studies
                    ? this.state.studies
                    : "Not given - double click to edit"}
                </p>
              ) : (
                <input
                  type="text"
                  ...
                  onDoubleClick={(e) => {
                    this.setState({});
                    this.handleInputDoubleclick();
                  }}
                  onChange={(e) => {
                    this.setState({ studies: e.target.value });
                  }}
                />
              )}
            ...
            <hr />
            <p className="bold allcaps about-me-caption">
