...
class Home extends Component<{}, State> {
  ...
  handleFormChange = () => {
    ...
    switch (this.state.selected) {
      case 0:
        return <Login onChildProps={this.handleLoginMessage} />;
      case 1:
        return <Register onChildProps={this.handleRegisterMessage} />;
      case 2:
        return <Search onChildProps={this.handleSearchMessage} />;
    }
  };
        ...
        <div className="container">
          <div className="centered">
            ...
            <div id="form-nav" className="centered">
              <ul>
                <li
                  id={this.state.selected === 0 ? "selected" : ""}
                  onClick={() => {
                ...
                <li
                  id={this.state.selected === 1 ? "selected" : ""}
                  onClick={() => {
                ...
                <li
                  id={this.state.selected === 2 ? "selected" : ""}
                  onClick={() => {
            ...
            <div className="forms-container">{this.handleFormChange()}</div>
